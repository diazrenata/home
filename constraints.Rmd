...
Working with a 40-year experimental manipulation of the rodent community near Portal, AZ, I am investigating [how environmental change and metacommunity dynamics determine the extent to which community level energy use is resilient to species extinctions.](https://doi.org/10.1101/2021.10.01.462799)
...
Working in collaboration with members of [Weecology](https://www.weecology.org), I am using machine learning and Bayesian changepoint analysis (implemented in the R packages [LDATS](https://weecology.github.io/LDATS/) and [cvlt](https://diazrenata.github.io/cvlt/)) to explore the frequency and timing of rapid reorganization events in the community composition of North American breeding bird communities. 
